...
... artifacts are [released to Clojars](https://clojars.org/server). If you are using Maven, add the following repository
...
server is built from the ground up for Clojure 1.5.1 and up.


## Continuous Integration Status

[![Continuous Integration status](https://secure.travis-ci.org/clojurewerkz/server.png)](http://travis-ci.org/clojurewerkz/server)



## ... Is a ClojureWerkz Project

server is part of the [group of Clojure libraries known as ClojureWerkz](http://clojurewerkz.org), together with
